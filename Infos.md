/*
Pour rendre ça flexible, il faut refactoriser vers une architecture basée sur un tableau de programmateurs plutôt que des variables séparées Re1/Re2/Re3/Re4 :
...
La sauvegarde NVS en boucle sur le tableau au lieu de champs nommés Re1/Re2/Re3/Re4

  { "Re1", "Programmation 1", "Cuisine",  "#f59e0b", 32, "08:00", "18:00", true, false },
...
Sauvegarde NVS en boucle : les clés sont générées dynamiquement (Re1debut, Re2debut...) au lieu d'être écrites une par une.
...
Dans le code, c'est simplement la couleur d'accent attribuée au relais "Re2 / Portail" : elle sert à colorer le liseré à gauche de sa carte dans l'interface 
