...
//
//  🔘 Bouton poussoir de forçage physique (optionnel, uniquement câblé ici sur PR1 à PR4) :
...
Programmateur programmateurs[] = {
  { "PR1", "Programmation 1", "Cuisine",  "#f59e0b", 32, "08:00", "18:00", true, false, 14 }, //#f59e0b est un code couleur hexadécimal R V B
  { "PR2", "Programmation 2", "Portail",  "#06b6d4", 33, "09:00", "19:00", true, false, 16 },
  { "PR3", "Programmation 3", "Relais 3", "#0CE892", 25, "10:00", "20:00", true, false, 17 },
  { "PR4", "Programmation 4", "Relais 4", "#ef4444", 26, "11:00", "21:00", true, false, 18 },

  // 👉 Exemples de lignes supplémentaires à décommenter/adapter pour aller au-delà de 4 relais :
  //🔘 (mettre N° de broche du GPIO en dernier pour un programmateur avec bouton poussoir ou -1 pour sans Bouton poussoir)
  // { "PR5",  "Programmation 5",  "Relais 5",  "#a78bfa", 27, "12:00", "22:00", true, false, -1 },
  // { "PR6",  "Programmation 6",  "Relais 6",  "#f472b6", 14, "13:00", "23:00", true, false, -1 },
  // { "PR7",  "Programmation 7",  "Relais 7",  "#38bdf8", 12, "07:00", "17:00", true, false, -1 },
  // { "PR8",  "Programmation 8",  "Relais 8",  "#fbbf24", 13, "06:00", "16:00", true, false, -1 },
};
...
// ============================================================================
//  🔘 BOUTONS POUSSOIRS DE FORÇAGE PHYSIQUE (PR1 à PR4 uniquement)
// ============================================================================
    ...
    if (millis() - bpDerniereBascule[i] > BP_DEBOUNCE_MS) {
      if (lecture != bpEtatStable[i]) {
        ...
        if (bpEtatStable[i] == LOW) { // Front descendant = appui réellement détecté
          ...
          saveSettings();                 // Sauvegarde le nouvel état forcé en NVS
